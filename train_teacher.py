...
if __name__ == "__main__":
    ...
    for i in range(args.procs):
        if use_pixel:
            env_fns.append(lambda: RGBImgPartialObsWrapper(gym.make(args.env, teacher = teacher)))
        else:
            env_fns.append(lambda: gym.make(args.env, teacher = teacher))
        enf_fn = lambda: gym.make(args.env, teacher = teacher)
